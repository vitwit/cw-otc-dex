...
//     console.log("activity",bid);
    return (<>
      <tr className="bg-white border-b hover:bg-slate-50">
                    ...
                    <td className="py-4 px-6">   <img src={icons[dealDenom]} alt={dealDenom} className="inline-block w-4 h-4 mr-1" /> {quantity}</td>
                    <td className="py-10 px-6 flex items-center justify-center"> <img src={icons[bid.denom]} alt={bid.denom} className="inline-block w-4 h-4 mr-1" /> {price}</td>
                    <td className="py-4 px-6">
